  ...
  return (
    <Layout showHeader={true} showFooter={true}>
      <Box sx={{ minHeight: '100vh' }}>
          ...
          <Container maxWidth="lg">
            <Box sx={{ maxWidth: '900px', mx: 'auto', textAlign: 'center' }}>
              ...
              <Typography variant="h5" sx={{ color: 'rgba(255, 255, 255, 0.9)', maxWidth: '700px', mx: 'auto' }}>
                Como utilizamos cookies e tecnologias similares na nossa plataforma
              </Typography>
        ...
        <Box sx={{ py: { xs: 4, md: 8 }, background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%)' }}>
          <Container maxWidth="md" sx={{ px: { xs: 2, md: 3 } }}>
            <Paper elevation={3} sx={{ p: { xs: 2, md: 4 } }}>
              <Box sx={{ mb: { xs: 3, md: 4 }, p: { xs: 2, md: 3 }, backgroundColor: 'rgba(59, 130, 246, 0.05)', borderRadius: 2 }}>
              ...
              {sections.map((section, index) => (
                <Box key={index} id={section.id} sx={{ mb: { xs: 4, md: 5 } }}>
                  {index > 0 && <Divider sx={{ mb: { xs: 3, md: 4 } }} />}
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2, flexWrap: 'wrap' }}>
                    {section.icon && (
                      <section.icon size={28} color="#3b82f6" style={{ width: 'clamp(20px, 5vw, 28px)', height: 'clamp(20px, 5vw, 28px)' }} />
                    )}
              ...
              <Box sx={{ textAlign: 'center', p: 3, backgroundColor: 'rgba(16, 185, 129, 0.05)', borderRadius: 2 }}>
                <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
                  Ao usar nossa plataforma, você concorda com esta Política de Cookies.
                </Typography>
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  ...
                  >
                    cookies@clarityaudio.com
                  </Link>
                </Typography>
              </Box>
            </Paper>

            <Box sx={{ mt: { xs: 3, md: 4 }, display: 'flex', gap: { xs: 1, md: 2 }, justifyContent: 'center', flexWrap: 'wrap' }}>
              <Typography
                component={Link}
                href="/terms"
                sx={{
              ...
              <Typography sx={{ color: 'text.secondary', fontSize: { xs: '0.875rem', md: '1rem' } }}>|</Typography>
              <Typography
                component={Link}
                href="/cookies"
                sx={{
